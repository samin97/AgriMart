...
class EditKiosk extends StatefulWidget {
  const EditKiosk({super.key});

  @override
  State<EditKiosk> createState() => _EditKioskState();
}

class _EditKioskState extends State<EditKiosk> {
  final category = [
    'Fruits',
    'Animal Products',
    'Vegetables',
